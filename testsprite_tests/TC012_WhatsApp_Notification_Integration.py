...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test plan execution failed: Automated WhatsApp notifications after transactions and custom message sending verification did not pass as expected.")
