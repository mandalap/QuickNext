...
| Variable           | Required | Default     | Description                                                      |
| ------------------ | -------- | ----------- | ---------------------------------------------------------------- |
| `REDIS_CLIENT`     | ⚠️       | `phpredis`  | Redis client (`phpredis` requires extension, `predis` is pure PHP) |
| `REDIS_HOST`       | ✅       | `127.0.0.1` | Redis server host                                                |
| `REDIS_PORT`       | ✅       | `6379`      | Redis server port                                                |
| `REDIS_PASSWORD`   | ⚠️       | `null`      | Redis password (set if Redis is password-protected)             |
| `REDIS_DB`         | ⚠️       | `0`         | Default Redis database number                                    |
| `REDIS_CACHE_DB`   | ⚠️       | `1`         | Redis database number for cache                                  |

#### **Cache Configuration**

| Variable        | Required | Default              | Description                                    |
| --------------- | -------- | -------------------- | ---------------------------------------------- |
| `CACHE_STORE`   | ✅       | `database`           | Cache driver (`redis`, `database`, `file`)    |
| `CACHE_PREFIX`   | ⚠️       | `quickkasir-cache-`  | Prefix for cache keys                          |

#### **Session Configuration**

| Variable            | Required | Default     | Description                                    |
| ------------------- | -------- | ----------- | ---------------------------------------------- |
| `SESSION_DRIVER`    | ✅       | `database`  | Session driver (`redis`, `database`, `file`)   |
| `SESSION_LIFETIME`  | ⚠️       | `120`       | Session lifetime in minutes                    |
| `SESSION_CONNECTION`| ⚠️       | `default`   | Redis connection name for session               |

#### **Queue Configuration**

| Variable                 | Required | Default    | Description                                    |
| ------------------------ | -------- | ---------- | ---------------------------------------------- |
| `QUEUE_CONNECTION`       | ✅       | `database` | Queue driver (`redis`, `database`, `sync`)   |
| `REDIS_QUEUE_CONNECTION`| ⚠️       | `default`  | Redis connection name for queue                 |
| `REDIS_QUEUE`            | ⚠️       | `default`  | Default queue name                              |
| `REDIS_QUEUE_RETRY_AFTER`| ⚠️       | `90`       | Retry after seconds                            |
