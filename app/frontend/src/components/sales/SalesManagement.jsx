            ...
            <TabsContent value='orders' className='space-y-4'>
              ...
              <div className='space-y-4'>
                {loading ? (
                  ...
                  // ✅ TEMPORARY: Use regular rendering instead of virtual scrolling to avoid react-window error
                  // TODO: Fix react-window itemData issue and re-enable virtual scrolling
                  <div className='space-y-4'>
