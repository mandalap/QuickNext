      ...
      <div className='flex flex-col items-center justify-center min-h-[60vh] space-y-4'>
        ...
        {noSubscriptionAccess ? (
          ...
          <>
            ...
            <p className='text-sm text-gray-500 text-center max-w-md mt-2'>
              Untuk mengaktifkan fitur Self Service, pastikan paket subscription Anda memiliki akses ke fitur ini. Upgrade ke paket <strong>Professional</strong> untuk mengaktifkan fitur Self Service dan fitur premium lainnya.
            </p>
            <div className='flex flex-col gap-2 mt-4'>
              <Button
                onClick={() => navigate('/subscription-plans')}
