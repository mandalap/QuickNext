    ...
    try {
      ...
      if (subResponse?.data?.success && subResponse.data.data) {
        ...
        if (isPending) {
          ...
          setError(
            'Pembayaran belum selesai. Silakan selesaikan pembayaran terlebih dahulu.'
          );
          ...
          if (subscription.subscription_code) {
            ...
            setError(
              'Pembayaran belum selesai. Silakan hubungi administrator untuk menyelesaikan pembayaran.'
            );
          }
          return;
        }
              ...
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <p className='text-sm'>
                    ...
                    subscription dan mengakses dashboard.
                  </p>
                </div>
              </div>
              <button
