...
const BusinessSetup = ({ onBusinessCreated, isInitialSetup = true }) => {
  ...
  const { loadBusinesses, businesses, subscriptionFeatures, checkSubscription } = useAuth();
  const {
    showLimitModal,
    limitError,
    handleLimitError,
  ...
  const handleSubmit = async e => {
    ...
    if (result.success) {
      ...
      // ✅ FIX: Navigate dengan replace untuk menghindari back button issues
      // ✅ FIX: Force reload setelah navigate untuk memastikan data ter-update
