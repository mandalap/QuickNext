<?php
/**
 * Test script untuk memeriksa API getShiftDetail dengan shift ID 49
 */
...
echo "🧪 Test Shift Detail API (ID 49)\n";
echo "=================================\n\n";

// 1. Cek shift ID 49
echo "1. 🔍 Shift ID 49:\n";
$shift = CashierShift::with(['user', 'outlet', 'orders.payments', 'orders.customer'])->find(49);
